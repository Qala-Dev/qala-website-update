...
const About: NextPage = () => {
  return (
    <>
      <Head>
        <title>What is Qala</title>
        <meta
          name="description"
          content=" For many African software developers, the pathway to a career as
          ...
          <div className="flex flex-col mt-8 lg:mt-16 w-full lg:w-[40.2rem]">
            ...
            <div className="mt-4 lg:mt-8">
              ...
              <P className="mt-4 text-center lg:text-justify">
                After completing a code challenge and attending short
                interviews, the top 50 performers were invited to start their
                peer-to-peer learning journey through study groups and virtual
                seminars where they learnt the fundamentals and philosophy
                behind Bitcoin. From this cohort, the top 12 candidates were
                chosen to join in the 3-month programme, where they gained
                advanced skills and have been matched with Bitcoin-first
                specific roles with organisations like Galoy and Btrust.
                Additionally, other fellows have turned into Qala mentors,
                sharing their Bitcoin insight with other up-and-coming African
                developers.
              </P>
              <P className="mt-4 text-center lg:text-justify">
                {" "}
                ...
                currently accepting applications for the next cohort, beginning
                Q1 2023. All skilled African software developers are encouraged
                to apply now and stay up to date with the latest information on
                the application process via the Qala Newsletter.
              </P>
            </div>
          </div>
        </div>
